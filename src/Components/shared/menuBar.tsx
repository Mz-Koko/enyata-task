...
const MenuBar: React.FC<Menu> = ({goBack, showBack}) => {

    return (
        <div className="flex flex-row items-center justify-between h-16 shadow-md w-full">
            { showBack ? <div className={`flex flex-row gap-2 pl-4 items-center cursor-pointer`}
            onClick={goBack}>
                ...
                <div className="text-[#A4A7B7] text-base font-normal leading-6">Back</div>
            </div>: <div className={`flex flex-row gap-2 pl-4 items-center cursor-pointer`} />}
            <div className="flex flex-row gap-8 pr-10 items-center">
